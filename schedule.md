...
| Wednesday, 12/2  | <span class="discussion">Discussion</span>: Jialin Li et al., ["Just say NO to Paxos Overhead: Replacing Consensus with Network Ordering" (OSDI 2016)](readings/network-ordering.pdf) | Reading response due noon PT on 12/1; scribes' wiki write-up due 11:59:59pm PT on 12/9
