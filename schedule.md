...
The course will alternate between <span class<span class="discussion">Discussion</span> and <span class="lecture">Lecture</span> days.  For days marked <span class="discussion">Discussion</span>, you must turn in your <a href="course-overview.html#reading-responses">reading response</a> for that day's reading assignment on Canvas **by noon Pacific time on the day prior to the day of class**.  For example, for the paper to be discussed on Wednesday, October 7, you must turn in your reading response on Canvas by noon Pacific time on Tuesday, October 6.
